                      ...
                      return (
                        <div key={o.id} className="px-6 py-4 flex items-center justify-between hover:bg-gray-50/50 transition-colors">
                          ...
                          <div className="flex items-center gap-4">
                            ...
                            <span className="font-black text-gray-900 text-sm">{o.total.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })}</span>
                          </div>
                        </div>
                      );
                    })}
                        ...
                        <div key={order.id} className={`bg-white rounded-2xl border shadow-sm overflow-hidden ${statusColors[order.status] || 'border-gray-100'}`}>
                          ...
                          <div className="px-6 py-4 flex items-start justify-between gap-4 border-b border-gray-100">
                            ...
                            <div className="text-right shrink-0">
                              <p className="font-black text-gray-900 text-lg">{order.total.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })}</p>
                            ...
                            <div className="px-6 pb-5 space-y-3">
                              ...
                              <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-3">
                                ...
                                <button
                                    ...
                                    try {
                                      ...
                                      if (order.customerId) {
                                        supabase.functions.invoke('send-push-notification', {
                                          body: {
                                            userId: order.customerId,
                                            title: '📦 Pedido devolvido ao restaurante',
                                            body: `Seu pedido de ${order.restaurantName} foi devolvido. Reembolso já processado.`,
                                            data: { orderId: order.id, type: 'RETURNED' },
                                          },
                                        }).catch(() => {});
                                      }
                                  ...
                                  className="w-full flex items-center justify-center gap-2 px-5 py-3.5 bg-green-600 text-white rounded-xl font-black text-sm disabled:opacity-50 active:scale-95 transition-all"
                                >
                              ...
                              <div className="bg-green-50 border border-green-100 rounded-xl px-4 py-3 flex items-start gap-3">
                                ...
                                <div>
                                  ...
                                  <p className="text-xs text-green-500 mt-0.5">
                                    Pedido devolvido ao restaurante e reembolso processado para o cliente.
                                    Caso o cliente não receba o reembolso em até 3 dias úteis, entre em contato com o suporte financeiro.
                                  </p>
                                </div>
                              </div>
                            </div>
